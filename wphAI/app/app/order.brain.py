"""
Moved to archive/legacy_order_brain. This legacy file was removed on 2025-10-24.
Please use app/order_brain.py going forward.
"""
...
def compute_order_qty(stanje: float, ulaz: float, mes_muj: float, izlaz: float,
                      min_zal: float, moq: int,
                      target_mode: str = TARGET_MODE,
                      ignore_ulaz: bool = IGNORE_ULAZ_IN_ORDER,
                      round_to_5_if_ge_10: bool = ROUND_TO_5_IF_GE_10):
    """Politika e porosisë: Target sipas mode, ULAZ opsional, MOQ, rrumbullakim 5-she."""
