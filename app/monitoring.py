...
class SystemMonitor:
    ...
    def check_database(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "healthy",
                "version": version.split(",")[0],  # Short version
                "size_mb": size_mb,
                "connections": connections,
                "response_time_ms": 0  # Could measure with timer
            }
    ...
    def get_full_health(self) -> Dict[str, Any]:
        ...
        all_healthy = all([
            ...
            cpu.get("status") in ["healthy", "warning"],
            memory.get("status") in ["healthy", "warning"],
            disk.get("status") in ["healthy", "warning"]
        ])
    ...
    def check_critical_issues(self) -> Optional[Dict[str, str]]:
