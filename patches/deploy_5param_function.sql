...
DECLARE
    ...
    v_pattern      TEXT;
BEGIN
    v_mv_name := CASE p_sales_window
        WHEN 7   THEN 'ops._sales_15d'
        WHEN 15  THEN 'ops._sales_15d'
        WHEN 30  THEN 'ops._sales_30d'
        WHEN 60  THEN 'ops._sales_60d'
        WHEN 180 THEN 'ops._sales_60d'
        ELSE 'ops._sales_30d'
    END;
